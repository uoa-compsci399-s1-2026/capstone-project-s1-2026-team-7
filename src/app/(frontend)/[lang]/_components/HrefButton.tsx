...
const baseClasses =
  'inline-flex min-w-[7.5625rem] items-center justify-center whitespace-nowrap rounded-full px-4 py-2 text-xs transition-all duration-200 sm:text-sm lg:text-lg'
